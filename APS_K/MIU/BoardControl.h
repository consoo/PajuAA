...
#define ERR_BOARD_SPI_WRITE			(15)
#define ERR_BOARD_SPI_READ			(16)
...
typedef enum _CRCTYPE
{
    ...
    CRC_TYPE_CHECKSUM_START = 100,
    CRC_TYPE_CHECKSUM16_RFC1071 = 100,
} CRCTYPE;
...
public:
    ...
    virtual int WriteSPI(unsigned char spi_Address, unsigned char spi_WriteData) = 0;

    virtual int ReadSPI(unsigned char spi_Address, unsigned char* spi_ReadData) = 0;

    virtual int GetGPIOMode(char nGPIONo, char* pMode) = 0;

    virtual int SetGPIOMode(char nGPIONo, char mode) = 0;

    virtual int GetGPIOStatus(char nGPIONo, char* pValue) = 0;

    virtual int SetGPIOStatus(char nGPIONo, char value) = 0;
