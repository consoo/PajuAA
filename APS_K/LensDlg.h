...
//	afx_msg void OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar);
	...
	afx_msg void OnBnClickedButtonPcbVaccumOn();
	afx_msg void OnBnClickedButtonPcbVaccumOff();
	CExButton m_btn_PcbVaccum_On;
	CExButton m_btn_PcbVaccum_Off;
	afx_msg void OnBnClickedButtonBcrRead();
};
