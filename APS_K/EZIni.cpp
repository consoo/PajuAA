...
{
	_SetKeyValue(dValue, _T("%lf"));
	return *this;
}

EZIni::Key& EZIni::Key::operator=(float fValue)
{
	_SetKeyValue(fValue, _T("%f"));
	return *this;
}
...
{
	CString sValue = _GetKeyValue(m_dDefaultValue, _T("%lf"));
	return _tstof(sValue);
}

EZIni::Key::operator float()
{
	CString sValue = _GetKeyValue(m_fDefaultValue, _T("%f"));
...
EZIni::Key& EZIni::Key::operator<<(float fDefaultValue)
{
