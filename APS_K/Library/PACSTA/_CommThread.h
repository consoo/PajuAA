...
public:
	...
	UINT nSizeReceived;
	void ComposePacket_oc(BYTE nID, BYTE nType, BYTE nBodyLength, BYTE* arrBody);
	void ComposePacket(BYTE nID, BYTE nType, BYTE nBodyLength, BYTE* arrBody);
	void ComposePacketFittingSet(BYTE nID, BYTE nType, BYTE nBodyLength, BYTE* arrBody);
