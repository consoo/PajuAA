...
void CLensDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_BUTTON_GRIP_ON, m_btnGrip_ON);
	DDX_Control(pDX, IDC_BUTTON_GRIP_OFF, m_btnGrip_OFF);// m_btnPcbReTurn);
	...
	DDX_Control(pDX, IDC_BUTTON_PCB_VACCUM_ON, m_btn_PcbVaccum_On);
	DDX_Control(pDX, IDC_BUTTON_PCB_VACCUM_OFF, m_btn_PcbVaccum_Off);
}
...
//	ON_WM_HSCROLL()
	...
	ON_BN_CLICKED(IDC_BUTTON_PCB_VACCUM_ON, &CLensDlg::OnBnClickedButtonPcbVaccumOn)
	ON_BN_CLICKED(IDC_BUTTON_PCB_VACCUM_OFF, &CLensDlg::OnBnClickedButtonPcbVaccumOff)
	ON_BN_CLICKED(IDC_BUTTON_BCR_READ, &CLensDlg::OnBnClickedButtonBcrRead)
END_MESSAGE_MAP()
...
void CLensDlg::changeColorPcbVaccumBtn()
{
	bool flag = false;
	bool flag2 = false;
	flag = Dio.PCBvaccumOnCheck(true, false);
	flag2 = Dio.PCBvaccumOnCheck(false, false);

	if (flag)
	{
		m_btn_PcbVaccum_On.m_iStateBtn = 1;
	}
	else
	{
		m_btn_PcbVaccum_On.m_iStateBtn = 0;
	}
	if (flag2)
	{
		m_btn_PcbVaccum_Off.m_iStateBtn = 1;
	}
	else
	{
		m_btn_PcbVaccum_Off.m_iStateBtn = 0;
	}

	m_btn_PcbVaccum_On.Invalidate();
	m_btn_PcbVaccum_Off.Invalidate();
}
...
void CLensDlg::changeColorGripBtn()
{
	...
	bool flag = false;
	bool flag2 = false;
	flag = Dio.HolderGripCheck(true, false);
	flag2 = Dio.HolderGripCheck(false, false);
...
void CLensDlg::OnBnClickedButtonPcbVaccumOn()
{
	// TODO: Add your control notification handler code here
	if (Task.AutoFlag == 1)
	{
...
void CLensDlg::OnBnClickedButtonPcbVaccumOff()
{
	// TODO: Add your control notification handler code here
	if (Task.AutoFlag == 1)
	{
	...
	Dio.PCBvaccumOn(VACCUM_OFF, false);      //흡착

	g_bMovingflag = false;
}


void CLensDlg::OnBnClickedButtonBcrRead()
{
	// TODO: Add your control notification handler code here
	if (Task.AutoFlag == 1)
	{
